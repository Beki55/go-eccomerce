...
import (
	...
	"github.com/beki55/go-ecommerce/services/coupon/models"
)

func main() {
	cfg := config.LoadServiceConfig("coupon-service", "8087", "go_ecommerce")
	...
	_ = rdb // Will be used for coupon validation caching
