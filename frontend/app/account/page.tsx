          ...
          <div className="lg:col-span-1">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #FFD700, #D4AF37, #FFA500)",
                }}
              />
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      >
                        <p className="font-serif text-3xl font-semibold gold-text mb-1">
                          {stat.value}
                        </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-xs font-sans text-muted-foreground hover:text-[#D4AF37] transition-colors"
                      >
                        View All
                      </button>
                    </div>
                    ...
                    >
                      {mockOrders.slice(0, 2).map((order) => (
                        ...
                        >
                          <div
                            className="relative w-12 h-16 rounded-lg overflow-hidden flex-shrink-0"
                          ...
                          <div className="text-right">
                            <p className="font-serif font-semibold gold-text">
                  ...
                  >
                    ...
                    >
                      {mockOrders.map((order) => (
                        <div
                          key={order.id}
                          className="flex items-center gap-4 p-5 hover:bg-[rgba(212,175,55,0.03)] transition-colors"
                        >
                          <div
                            className="relative w-14 h-18 rounded-lg overflow-hidden flex-shrink-0"
                            style={{ border: "1px solid rgba(212,175,55,0.2)" }}
                          >
                            <Image
                              src={order.product.images[0]}
                          ...
                          <div className="text-right">
                            <p className="font-serif font-semibold text-xl gold-text">
                              ${order.total.toLocaleString()}
                            </p>
                            <span
                  ...
                  >
                    ...
                    {wishlist.length === 0 ? (
                      <div className="p-12 text-center">
                        ...
                        <Link
                          href="/products"
                          className="gold-outline-btn rounded inline-flex mt-4 text-sm"
                        >
                          Browse Collection
                        </Link>
                      </div>
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <Link href={`/products/${product.id}`}>
                                <p className="font-serif text-base font-medium hover:text-[#D4AF37] transition-colors">
                                  {product.name}
                                </p>
                              </Link>
                            ...
                            <div className="flex flex-col items-end gap-2">
                              ...
                              <Link
                                href={`/products/${product.id}`}
                                className="text-xs gold-btn rounded px-3 py-1.5"
                              >
                                Add to Cart
                              </Link>
                              <button
                ...
                >
                  {mockAddresses.map((addr) => (
                    ...
                    >
                      {addr.default && (
                        <span
                          className="absolute top-4 right-4 px-2 py-0.5 text-xs font-sans font-semibold rounded-full"
                          style={{
                  ...
                  <button
                    className="w-full rounded-xl p-4 border-2 border-dashed text-muted-foreground hover:text-[#D4AF37] hover:border-[#D4AF37] transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                ...
                >
                  ...
                  >
                    <h3 className="font-serif text-xl font-light mb-6 flex items-center gap-2">
                      <User size={18} style={{ color: "#D4AF37" }} /> Profile
                      Information
                    </h3>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          label: "Order Updates",
                          desc: "Receive shipping and delivery notifications",
                        },
                        {
                          label: "New Arrivals",
                          desc: "Be first to know about new luxury pieces",
                        },
                        {
                          label: "Exclusive Offers",
                          desc: "Members-only promotions and events",
                        },
                      ].map((item) => (
                        <div
                          key={item.label}
