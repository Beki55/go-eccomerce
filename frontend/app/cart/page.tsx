...
export default function CartPage() {
  const { items, removeItem, updateQuantity, subtotal, isLoading, error } =
    useCart();
  ...
  const handleApplyCoupon = () => {
    ...
    if (VALID_COUPONS[upper]) {
      ...
      setCouponSuccess(
        `${Math.round(VALID_COUPONS[upper] * 100)}% discount applied!`,
      );
      setCouponError("");
    } else {
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 py-20 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm mb-8 font-light">
              Discover our curated collection of luxury goods and add your
              favourites.
            </p>
            <Link
              href="/products"
