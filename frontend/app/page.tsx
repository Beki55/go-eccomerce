...
export default function HomePage() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-4 pt-20">
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.4) 50%, rgba(0,0,0,0.75) 100%)",
            }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            Discover luxury at your fingertips — where every piece tells a story
            of masterful craftsmanship and timeless elegance.
          </motion.p>
          ...
          >
            <Link
              href="/products"
              className="gold-btn rounded shimmer-overlay flex items-center gap-2"
            >
              Shop Collection
              <ArrowRight size={16} />
            </Link>
            <Link
              href="/products"
              className="px-8 py-3 font-sans font-semibold text-sm tracking-widest uppercase text-white border border-white/30 rounded hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all duration-300"
            >
              Explore More
            </Link>
          </motion.div>
          ...
          >
            {[
              ...
              <div key={stat.label} className="text-center">
                ...
                <p className="text-xs font-sans tracking-widest uppercase text-white/60 mt-1">
                  {stat.label}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <FadeInSection delay={0.3}>
            <div className="text-center mt-12">
              <Link
                href="/products"
                className="gold-outline-btn rounded inline-flex items-center gap-2"
              >
      ...
      {/* Marquee Banner */}
      <section
        className="relative z-10 py-6 overflow-hidden border-y"
        style={{
      ...
      >
        ...
        >
          {Array.from({ length: 8 }).map((_, i) => (
            <span
              key={i}
              className="flex items-center gap-8 font-sans text-sm tracking-widest uppercase"
            >
          ...
          <FadeInSection>
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-5xl md:text-6xl font-light">
                What Our{" "}
                <span className="gold-text font-semibold">Clients Say</span>
              </h2>
              <div className="gold-divider max-w-xs mx-auto mt-4" />
            </div>
          </FadeInSection>
          ...
          <FadeInSection>
            ...
            >
              ...
              <h2 className="font-serif text-4xl md:text-5xl font-light mb-4">
                Join the{" "}
                <span className="gold-text font-semibold">Inner Circle</span>
              </h2>
              <p className="text-muted-foreground text-sm leading-relaxed mb-8 font-light max-w-sm mx-auto">
                Receive exclusive invitations, early access to new arrivals, and
                curated recommendations tailored for you.
              </p>
