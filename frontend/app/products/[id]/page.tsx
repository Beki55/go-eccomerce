          ...
          <div className="flex flex-col">
            ...
            <div className="mb-8">
              ...
              >
                ...
                <span
                  className="w-12 text-center font-sans font-semibold"
                  style={{
                ...
                <div className="space-y-4 max-w-md">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground font-light">
                      Complimentary white-glove delivery worldwide. Standard
                      delivery in 3-5 business days. Express available.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground font-light">
                      We offer a 30-day return policy. Items must be in original
