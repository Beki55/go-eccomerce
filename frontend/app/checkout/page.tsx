      ...
      <div className="relative min-h-screen pt-20 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm font-light leading-relaxed mb-8">
            Your order has been received and is being prepared with the utmost
            care. You will receive a confirmation email shortly with tracking
            details.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/account"
              className="gold-btn rounded flex items-center gap-2 justify-center"
            >
              View My Orders
            </Link>
            <Link
              href="/products"
              className="gold-outline-btn rounded flex items-center gap-2 justify-center"
            >
              Continue Shopping
            </Link>
          </div>
                ...
                >
                  ...
                  >
                    {currentStep > step.id ? (
                      ...
                      <step.icon
                        size={16}
                        color={currentStep >= step.id ? "#000" : "#D4AF37"}
                      />
                    )}
                  </div>
                  <span
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <button
                    ...
                    className="gold-btn rounded-lg w-full mt-6 flex items-center justify-center gap-2 py-4"
                  >
